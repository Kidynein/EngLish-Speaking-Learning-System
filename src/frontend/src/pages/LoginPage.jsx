              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-600 bg-slate-700 px-4 py-3 pr-12 text-sm text-white placeholder:text-slate-400 focus:border-brand-tertiary focus:outline-none focus:ring-2 focus:ring-brand-tertiary/30 transition-all duration-300"
                    placeholder="••••••••"
                    required
                  />
                  <button
